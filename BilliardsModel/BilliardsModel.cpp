...
// BilliardsModel.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CBilliardsModelApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CBilliardsModelApp

CBilliardsModelApp::CBilliardsModelApp()
{
...
// Единственный объект CBilliardsModelApp

CBilliardsModelApp theApp;


// Инициализация CBilliardsModelApp

BOOL CBilliardsModelApp::InitInstance()
{
